...
- DMG 산출물은 Apple Silicon macOS용 `MinNote_<version>.dmg`입니다.
...
- 버전 변경 시 아래 4개 파일을 항상 같은 버전으로 맞춥니다.
  - [`package.json`](/Users/seongmin/Personal/MinNote/package.json)
  - [`src-tauri/tauri.conf.json`](/Users/seongmin/Personal/MinNote/src-tauri/tauri.conf.json)
  - [`src-tauri/Cargo.toml`](/Users/seongmin/Personal/MinNote/src-tauri/Cargo.toml)
